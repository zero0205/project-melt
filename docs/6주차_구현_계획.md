...
public class EnhancedDispatcherServlet extends HttpServlet {
    ...
    public static class HandlerMapping {
        ...
        Method method;        // 실제 Java 메소드
        Object controller;    // 컨트롤러 인스턴스
        ...
        for (Object controller : controllers.values()) {
            ...
            for (Method method : methods) {
                if (method.isAnnotationPresent(RequestMapping.class)) {
                    ...
                    handlerMapping.httpMethod = mapping.method().name();
                    handlerMapping.urlPattern = mapping.value();
                    handlerMapping.method = method;
    ...
    private Object parseJson(String json, Class<?> targetType) {
        ...
        if (targetType.getSimpleName().equals("User")) {
            User user = new User();
            // {"name":"john","age":25} 같은 간단한 JSON 파싱
